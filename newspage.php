      ...
      <div class="container">
        <div class="header-flex">
          ...
          <nav class="navigation">
            <a href="index.html#first-section" class="nav-bar">Our Hotel</a>
            <a href="index.html#second-section" class="nav-bar"
              >Rooms & Rates</a
            >
            <a href="index.html#third-section" class="nav-bar">Facilities</a>
            <a href="newspage.html" class="nav-bar">Contact Us</a>
          </nav>
        </div>
      </div>
    </header>
            ...
            <div class="news-card">
              ...
              <div class="news-card-content">
                ...
                <p class="card-title">
                  ...
                  quis urna id arcu mattis porttitor laoreet at eros.
                </p>
      ...
      <section class="news-second-section">
        <div class="container">
          ...
          <div class="gallery-grid">
            <img src="./images/news4.png" alt="Gallery img" />
            <img src="./images/news2.png" alt="Gallery img" />
            <img src="./images/news3.png" alt="Gallery img" />
            <img src="./images/news1.png" alt="Gallery img" />
          </div>
        </div>
      </section>
    </main>
    ...
    <footer>
      <div class="container">
        <div class="footer-content">
          <a href="index.html"
            ><img src="./images/lastimg.png" alt="footer logo"
          /></a>
